...
const state = {
  ...
  lang: window.localStorage['gc_language'] || 'ko_KR',
  config: {
    reseau: 'ElBichop',
...
const getters = {
  ...
  homeCurrentSelect: ({ homeCurrentSelect }) => homeCurrentSelect
}
...
const actions = {
  ...
  setHomeCurrentSelect ({ commit }, value) {
    commit('SET_HOME_CURRENT_SELECT', value)
  }
}
...
const mutations = {
  ...
  SET_HOME_CURRENT_SELECT (state, homeCurrentSelect) {
    state.homeCurrentSelect = homeCurrentSelect
  }
}
