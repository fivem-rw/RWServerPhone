...
const state = {
  twitterUsername: localStorage['rwphone_twitter_username'],
  twitterPassword: localStorage['rwphone_twitter_password'],
  twitterAvatarUrl: localStorage['rwphone_twitter_avatarUrl'],
  twitterNotification: localStorage['rwphone_twitter_notif'] ? parseInt(localStorage['rwphone_twitter_notif']) : 1,
  twitterNotificationSound: localStorage['rwphone_twitter_notif_sound'] !== 'false',
  tweets: [],
  favoriteTweets: []
}
...
const actions = {
  ...
  twitterLogout ({ commit }) {
    localStorage.removeItem('rwphone_twitter_username')
    localStorage.removeItem('rwphone_twitter_password')
    localStorage.removeItem('rwphone_twitter_avatarUrl')
  ...
  setAccount ({ commit }, data) {
    localStorage['rwphone_twitter_username'] = data.username
    localStorage['rwphone_twitter_password'] = data.password
    localStorage['rwphone_twitter_avatarUrl'] = data.avatarUrl
