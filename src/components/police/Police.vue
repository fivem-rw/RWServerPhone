<template>
  <div class="phone_app">
    <PhoneTitle :title="IntlString('APP_POLICE_TITLE')" @back="onBackspace"/>
...
export default {
  ...
  computed: {
    ...
    paramList () {
      ...
      const confirmResetStr = this.IntlString('APP_POLICE_RESET_CONFIRM')
      const cancelOption = {}
      const confirmReset = {}
      ...
      return [
        ...
        },
        {
          ...
          onValid: 'setControlAction',
          values: {
            'choice_putinveh': '차량에 태우기',
            'choice_getoutveh': '차량에서 내쫒기',
            'ch_deleteveh': '차량 삭제'
          }
        },
        {
          ...
          onValid: 'setControlAction',
          values: {
            'choice_seize_items': '불법적인 물건',
            'choice_seize_weapons': '불법적인 무기'
          }
        },
        {
          icons: 'fa-user-secret',
        ...
        },
        {
          ...
          onValid: 'setControlAction',
          values: {
            'vrp_ptracking_ch_tracking': '추적시작'
          }
        },
        {
          icons: 'fa-user-secret',
          ...
          onValid: 'setControlAction',
          values: {
            'vrp_licrevoked_ch_checklic': '면허조회',
            'vrp_licrevoked_ch_setrevokelic': '면허정지',
            'vrp_licrevoked_ch_removerevokelic': '면허정지해제'
          }
        },
        {
          icons: 'fa-user-secret',
        ...
        },
        {
          ...
          onValid: 'setControlAction',
          values: {
            'ch_kys_alarm_on': '교정국알람 켜기',
            'ch_kys_alarm_off': '교정국알람 끄기'
          }
        },
        {
          icons: 'fa-user-secret',
          ...
          onValid: 'setControlAction',
          values: {
            'ch_kys_screen_on': '교정국스크린 켜기',
            'ch_kys_screen_off': '교정국스크린 끄기'
          }
        },
        {
          icons: 'fa-user-secret',
        ...
        },
        {
          ...
          onValid: 'setControlAction',
          values: {
            'vrp_barrier_ch_barrier_1': '배리어1 설치',
            'vrp_barrier_ch_barrier_2': '배리어2 설치',
            'vrp_barrier_ch_barrier_spikes': '스파이크 설치',
            'vrp_barrier_ch_barrier_cone': '콘 설치'
          }
        }
      ]
    },
