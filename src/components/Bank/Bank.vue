    ...
    <div class='elements'>
      ...
      <div class='element'>
        ...
        <div class="element-content" ref="form"> 
          <input style=" border-radius: 23px; font-size: 16px;" v-bind:class="{ select: 0 === currentSelect}" v-autofocus oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '￦1');" ref="form0" v-model="id" class="paragonder" placeholder="계좌번호">
        </div> 

        <div class="element-content">           
          <input  style=" border-radius: 23px; font-size: 16px;" v-bind:class="{ select: 1 === currentSelect}" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '￦1');" ref="form1" v-model="paratutar" class="paragonder" placeholder="금액">
