<template>
  <div class="phone_app">
    <PhoneTitle :title="IntlString('APP_ORGAN_TITLE')" @back="onBackspace"/>
...
export default {
  ...
  computed: {
    ...
    paramList () {
      ...
      const confirmResetStr = this.IntlString('APP_ORGAN_RESET_CONFIRM')
      const cancelOption = {}
      const confirmReset = {}
